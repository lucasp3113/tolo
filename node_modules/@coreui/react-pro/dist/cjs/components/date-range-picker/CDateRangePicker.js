...
var CDateRangePicker = React.forwardRef(function (_a, ref) {
    var _b;
    var ariaNavNextMonthLabel = _a.ariaNavNextMonthLabel, ariaNavNextYearLabel = _a.ariaNavNextYearLabel, ariaNavPrevMonthLabel = _a.ariaNavPrevMonthLabel, ariaNavPrevYearLabel = _a.ariaNavPrevYearLabel, _c = _a.calendars, calendars = _c === void 0 ? 2 : _c, _d = _a.cancelButton, cancelButton = _d === void 0 ? 'Cancel' : _d, _e = _a.cancelButtonColor, cancelButtonColor = _e === void 0 ? 'primary' : _e, _f = _a.cancelButtonSize, cancelButtonSize = _f === void 0 ? 'sm' : _f, _g = _a.cancelButtonVariant, cancelButtonVariant = _g === void 0 ? 'ghost' : _g, className = _a.className, _h = _a.cleaner, cleaner = _h === void 0 ? true : _h, _j = _a.closeOnSelect, closeOnSelect = _j === void 0 ? true : _j, _k = _a.confirmButton, confirmButton = _k === void 0 ? 'OK' : _k, _l = _a.confirmButtonColor, confirmButtonColor = _l === void 0 ? 'primary' : _l, _m = _a.confirmButtonSize, confirmButtonSize = _m === void 0 ? 'sm' : _m, confirmButtonVariant = _a.confirmButtonVariant, dayFormat = _a.dayFormat, disabled = _a.disabled, disabledDates = _a.disabledDates, endDate = _a.endDate, feedback = _a.feedback, feedbackInvalid = _a.feedbackInvalid, feedbackValid = _a.feedbackValid, firstDayOfWeek = _a.firstDayOfWeek, footer = _a.footer, id = _a.id, _o = _a.indicator, indicator = _o === void 0 ? true : _o, inputDateFormat = _a.inputDateFormat, inputDateParse = _a.inputDateParse, _p = _a.inputOnChangeDelay, inputOnChangeDelay = _p === void 0 ? 750 : _p, inputReadOnly = _a.inputReadOnly, invalid = _a.invalid, label = _a.label, _q = _a.locale, locale = _q === void 0 ? 'default' : _q, maxDate = _a.maxDate, minDate = _a.minDate, name = _a.name, navigation = _a.navigation, navYearFirst = _a.navYearFirst, onEndDateChange = _a.onEndDateChange, onHide = _a.onHide, onStartDateChange = _a.onStartDateChange, onShow = _a.onShow, _r = _a.placeholder, placeholder = _r === void 0 ? ['Start date', 'End date'] : _r, _s = _a.portal, portal = _s === void 0 ? true : _s, _t = _a.previewDateOnHover, previewDateOnHover = _t === void 0 ? true : _t, _u = _a.range, range = _u === void 0 ? true : _u, ranges = _a.ranges, _v = _a.rangesButtonsColor, rangesButtonsColor = _v === void 0 ? 'secondary' : _v, rangesButtonsSize = _a.rangesButtonsSize, _w = _a.rangesButtonsVariant, rangesButtonsVariant = _w === void 0 ? 'ghost' : _w, required = _a.required, _x = _a.separator, separator = _x === void 0 ? true : _x, selectAdjacementDays = _a.selectAdjacementDays, _y = _a.selectionType, selectionType = _y === void 0 ? 'day' : _y, showAdjacementDays = _a.showAdjacementDays, showWeekNumber = _a.showWeekNumber, size = _a.size, startDate = _a.startDate, text = _a.text, timepicker = _a.timepicker, toggler = _a.toggler, _z = _a.todayButton, todayButton = _z === void 0 ? 'Today' : _z, _0 = _a.todayButtonColor, todayButtonColor = _0 === void 0 ? 'primary' : _0, _1 = _a.todayButtonSize, todayButtonSize = _1 === void 0 ? 'sm' : _1, todayButtonVariant = _a.todayButtonVariant, tooltipFeedback = _a.tooltipFeedback, valid = _a.valid, visible = _a.visible, weekdayFormat = _a.weekdayFormat, weekNumbersLabel = _a.weekNumbersLabel, _2 = _a.calendarDate, calendarDate = _2 === void 0 ? startDate || endDate || null : _2, rest = tslib_es6.__rest(_a, ["ariaNavNextMonthLabel", "ariaNavNextYearLabel", "ariaNavPrevMonthLabel", "ariaNavPrevYearLabel", "calendars", "cancelButton", "cancelButtonColor", "cancelButtonSize", "cancelButtonVariant", "className", "cleaner", "closeOnSelect", "confirmButton", "confirmButtonColor", "confirmButtonSize", "confirmButtonVariant", "dayFormat", "disabled", "disabledDates", "endDate", "feedback", "feedbackInvalid", "feedbackValid", "firstDayOfWeek", "footer", "id", "indicator", "inputDateFormat", "inputDateParse", "inputOnChangeDelay", "inputReadOnly", "invalid", "label", "locale", "maxDate", "minDate", "name", "navigation", "navYearFirst", "onEndDateChange", "onHide", "onStartDateChange", "onShow", "placeholder", "portal", "previewDateOnHover", "range", "ranges", "rangesButtonsColor", "rangesButtonsSize", "rangesButtonsVariant", "required", "separator", "selectAdjacementDays", "selectionType", "showAdjacementDays", "showWeekNumber", "size", "startDate", "text", "timepicker", "toggler", "todayButton", "todayButtonColor", "todayButtonSize", "todayButtonVariant", "tooltipFeedback", "valid", "visible", "weekdayFormat", "weekNumbersLabel", "calendarDate"]);
    var inputEndRef = React.useRef(null);
    var inputStartRef = React.useRef(null);
    var formRef = React.useRef(null);
    var _3 = React.useState(calendarDate), _calendarDate = _3[0], setCalendarDate = _3[1];
    var _4 = React.useState(endDate !== null && endDate !== void 0 ? endDate : null), _endDate = _4[0], setEndDate = _4[1];
    var _5 = React.useState(maxDate !== null && maxDate !== void 0 ? maxDate : null), _maxDate = _5[0], setMaxDate = _5[1];
    var _6 = React.useState(minDate !== null && minDate !== void 0 ? minDate : null), _minDate = _6[0], setMinDate = _6[1];
    var _7 = React.useState(startDate !== null && startDate !== void 0 ? startDate : null), _startDate = _7[0], setStartDate = _7[1];
    var _8 = React.useState(visible), _visible = _8[0], setVisible = _8[1];
    var _9 = React.useState(startDate !== null && startDate !== void 0 ? startDate : null), initialStartDate = _9[0], setInitialStartDate = _9[1];
    var _10 = React.useState(endDate !== null && endDate !== void 0 ? endDate : null), initialEndDate = _10[0], setInitialEndDate = _10[1];
    var _11 = React.useState(null), inputStartHoverValue = _11[0], setInputStartHoverValue = _11[1];
    var _12 = React.useState(null), inputEndHoverValue = _12[0], setInputEndHoverValue = _12[1];
    var _13 = React.useState(valid !== null && valid !== void 0 ? valid : (invalid === true ? false : undefined)), isValid = _13[0], setIsValid = _13[1];
    var _14 = React.useState(false), selectEndDate = _14[0], setSelectEndDate = _14[1];
    ...
    var handleOnChange = useDebouncedCallback.useDebouncedCallback(function (value, input) {
        ...
        if (input === 'start') {
            setStartDate(date !== null && date !== void 0 ? date : null);
            onStartDateChange === null || onStartDateChange === void 0 ? void 0 : onStartDateChange(date !== null && date !== void 0 ? date : null);
        }
        else {
            setEndDate(date !== null && date !== void 0 ? date : null);
            onEndDateChange === null || onEndDateChange === void 0 ? void 0 : onEndDateChange(date !== null && date !== void 0 ? date : null);
        }
    }, inputOnChangeDelay);
