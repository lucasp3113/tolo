...
var CMultiSelect = React.forwardRef(function (_a, ref) {
    var _b;
    var allowCreateOptions = _a.allowCreateOptions, _c = _a.ariaCleanerLabel, ariaCleanerLabel = _c === void 0 ? 'Clear all selections' : _c, _d = _a.ariaIndicatorLabel, ariaIndicatorLabel = _d === void 0 ? 'Toggle visibility of options menu' : _d, className = _a.className, _e = _a.cleaner, cleaner = _e === void 0 ? true : _e, clearSearchOnSelect = _a.clearSearchOnSelect, container = _a.container, disabled = _a.disabled, feedback = _a.feedback, feedbackInvalid = _a.feedbackInvalid, feedbackValid = _a.feedbackValid, id = _a.id, invalid = _a.invalid, label = _a.label, loading = _a.loading, _f = _a.multiple, multiple = _f === void 0 ? true : _f, name = _a.name, onChange = _a.onChange, onFilterChange = _a.onFilterChange, onHide = _a.onHide, onShow = _a.onShow, options = _a.options, _g = _a.optionsMaxHeight, optionsMaxHeight = _g === void 0 ? 'auto' : _g, _h = _a.optionsStyle, optionsStyle = _h === void 0 ? 'checkbox' : _h, optionsTemplate = _a.optionsTemplate, optionsGroupsTemplate = _a.optionsGroupsTemplate, _j = _a.placeholder, placeholder = _j === void 0 ? 'Select...' : _j, _k = _a.portal, portal = _k === void 0 ? false : _k, required = _a.required, _l = _a.resetSelectionOnOptionsChange, resetSelectionOnOptionsChange = _l === void 0 ? false : _l, _m = _a.search, search = _m === void 0 ? true : _m, _o = _a.searchNoResultsLabel, searchNoResultsLabel = _o === void 0 ? 'No results found' : _o, _p = _a.selectAll, selectAll = _p === void 0 ? true : _p, _q = _a.selectAllLabel, selectAllLabel = _q === void 0 ? 'Select all options' : _q, _r = _a.selectionType, selectionType = _r === void 0 ? 'tags' : _r, _s = _a.selectionTypeCounterText, selectionTypeCounterText = _s === void 0 ? 'item(s) selected' : _s, size = _a.size, text = _a.text, tooltipFeedback = _a.tooltipFeedback, valid = _a.valid, value = _a.value, virtualScroller = _a.virtualScroller, _t = _a.visible, visible = _t === void 0 ? false : _t, _u = _a.visibleItems, visibleItems = _u === void 0 ? 10 : _u, rest = tslib_es6.__rest(_a, ["allowCreateOptions", "ariaCleanerLabel", "ariaIndicatorLabel", "className", "cleaner", "clearSearchOnSelect", "container", "disabled", "feedback", "feedbackInvalid", "feedbackValid", "id", "invalid", "label", "loading", "multiple", "name", "onChange", "onFilterChange", "onHide", "onShow", "options", "optionsMaxHeight", "optionsStyle", "optionsTemplate", "optionsGroupsTemplate", "placeholder", "portal", "required", "resetSelectionOnOptionsChange", "search", "searchNoResultsLabel", "selectAll", "selectAllLabel", "selectionType", "selectionTypeCounterText", "size", "text", "tooltipFeedback", "valid", "value", "virtualScroller", "visible", "visibleItems"]);
    var _v = useDropdownWithPopper.useDropdownWithPopper(), dropdownMenuElement = _v.dropdownMenuElement, dropdownRefElement = _v.dropdownRefElement, isOpen = _v.isOpen, closeDropdown = _v.closeDropdown, openDropdown = _v.openDropdown, toggleDropdown = _v.toggleDropdown, updatePopper = _v.updatePopper;
    var nativeSelectRef = React.useRef(null);
    var searchRef = React.useRef(null);
    var isInitialMount = React.useRef(true);
    var uniqueId = React.useId();
    var _w = React.useState(''), searchValue = _w[0], setSearchValue = _w[1];
    var _x = React.useState([]), selected = _x[0], setSelected = _x[1];
    var _y = React.useState([]), userOptions = _y[0], setUserOptions = _y[1];
    ...
    var flattenedOptions = React.useMemo(function () {
        return utils.flattenOptionsArray(options).map(function (option) {
            if (value && Array.isArray(value)) {
                return tslib_es6.__assign(tslib_es6.__assign({}, option), { selected: value.includes(option.value) });
            }
            if (value === option.value) {
                return tslib_es6.__assign(tslib_es6.__assign({}, option), { selected: true });
            }
            return option;
        });
    }, [options, value]);
    ...
    return (React.createElement(CFormControlWrapper.CFormControlWrapper, { describedby: rest['aria-describedby'], feedback: feedback, feedbackInvalid: feedbackInvalid, feedbackValid: feedbackValid, id: id !== null && id !== void 0 ? id : uniqueId, invalid: invalid, label: label, text: text, tooltipFeedback: tooltipFeedback, valid: valid },
        ...
        React.createElement("div", { className: index.default('form-multi-select', (_b = {},
            ...
            React.createElement("div", tslib_es6.__assign({ className: "form-multi-select-input-group" }, (!search && !disabled && { tabIndex: 0 }), { onClick: function () { return !disabled && openDropdown(); }, onKeyDown: handleTogglerKeyDown, role: "combobox", "aria-haspopup": "listbox", "aria-expanded": isOpen }, (portal && { 'aria-owns': "multiselect-listbox-".concat(uniqueId) }), { ref: dropdownRefElement }),
                React.createElement(CMultiSelectSelection.CMultiSelectSelection, { disabled: disabled, multiple: multiple, onRemove: function (option) { return !disabled && handleOnOptionClick(option); }, placeholder: placeholder, search: search, selected: selected, selectionType: selectionType, selectionTypeCounterText: selectionTypeCounterText },
                    search && (React.createElement("input", tslib_es6.__assign({ type: "text", className: "form-multi-select-search", disabled: disabled, id: "search".concat(id !== null && id !== void 0 ? id : uniqueId), name: "search".concat(name !== null && name !== void 0 ? name : uniqueId), autoComplete: "off", onChange: handleSearchChange, onKeyDown: handleSearchKeyDown }, (selected.length === 0 && { placeholder: placeholder }), (selected.length > 0 &&
            ...
            React.createElement(CConditionalPortal.CConditionalPortal, { container: container, portal: portal },
                React.createElement("div", { className: index.default('form-multi-select-dropdown', {
                        show: portal && isOpen,
                    }), id: "multiselect-listbox-".concat(uniqueId), onKeyDown: handleGlobalSearch, role: "listbox", "aria-multiselectable": multiple, ref: dropdownMenuElement },
