...
var CDropdown = React.forwardRef(function (_a, ref) {
    ...
    var _l = React.useState(null), dropdownToggleElement = _l[0], setDropdownToggleElement = _l[1];
    var _m = React.useState(visible), _visible = _m[0], setVisible = _m[1];
    var _o = usePopper.usePopper(), initPopper = _o.initPopper, destroyPopper = _o.destroyPopper;
    var dropdownToggleRef = React.useCallback(function (node) {
        if (node) {
    ...
    var computedPopperConfig = React.useMemo(function () {
        ...
        return tslib_es6.__assign(tslib_es6.__assign({}, defaultPopperConfig), (typeof popperConfig === 'function' ? popperConfig(defaultPopperConfig) : popperConfig));
