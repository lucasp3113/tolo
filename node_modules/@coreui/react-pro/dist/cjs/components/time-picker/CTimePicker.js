...
var CTimePicker = React.forwardRef(function (_a, ref) {
    ...
    var handleOnChange = useDebouncedCallback.useDebouncedCallback(function (value) {
        if (utils.isValidTime(value)) {
            var date_1 = utils.convertTimeToDate(value);
            setDate(date_1);
            if (date_1) {
                onTimeChange === null || onTimeChange === void 0 ? void 0 : onTimeChange(date_1.toTimeString(), date_1.toLocaleTimeString(), date_1);
            }
            else {
                onTimeChange === null || onTimeChange === void 0 ? void 0 : onTimeChange(null);
            }
