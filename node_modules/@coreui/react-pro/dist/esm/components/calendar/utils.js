...
var getDateBySelectionType = function (date, selectionType) {
    ...
    if (selectionType === 'week') {
        var _a = getISOWeekNumberAndYear(date), year = _a.year, weekNumber = _a.weekNumber;
        return "".concat(year, "W").concat(weekNumber.toString().padStart(2, '0'));
    }
 ...
 */
var getISOWeekNumberAndYear = function (date) {
    ...
    return { weekNumber: weekNumber, year: tempDate.getFullYear() };
};
/**
...
var getMonthDetails = function (year, month, firstDayOfWeek) {
    ...
    days.forEach(function (day, index) {
        ...
        if ((index + 1) % 7 === 0) {
            var _a = getISOWeekNumberAndYear(day.date), weekNumber = _a.weekNumber, year_1 = _a.year;
            weeks[weeks.length - 1].week = { number: weekNumber, year: year_1 };
        }
