    ...
    var createOptions = function (options) {
        return options.length > 0 ? (options.map(function (option, index) {
            return 'value' in option ? (React.createElement("div", { className: classNames('form-multi-select-option', {
                ...
                }), key: index, onClick: function () { return onOptionOnClick && onOptionOnClick(option); }, onKeyDown: function (event) { return handleKeyDown(event, option); }, tabIndex: 0, role: "option", "aria-selected": selected.some(function (_option) { return _option.value === option.value; }), "aria-disabled": Boolean(option.disabled) }, optionsTemplate ? optionsTemplate(option) : option.label)) : (React.createElement("div", { className: "form-multi-select-optgroup-label", key: index }, optionsGroupsTemplate ? optionsGroupsTemplate(option) : option.label));
