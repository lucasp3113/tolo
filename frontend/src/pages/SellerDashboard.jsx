...
export default function SellerDashboard({ children }) {
        ...
        <div className="flex-1 p-4 flex flex-col gap-4 pb-6">
          <div className="flex gap-3">
            <button
              ...
              className="flex-1 bg-gradient-to-r from-sky-800 to-sky-700 cursor-pointer text-white font-semibold py-3 px-4 rounded-xl shadow-md font-quicksand text-sm"
            >
              Añadir producto
            </button>
            <button
            ...
            <div className="flex items-center justify-between mb-3 pb-3 border-b border-gray-100">
              ...
              <div className="flex gap-1 bg-gray-50 p-1 rounded-lg">
                ...
                <button
                  ...
                  className={`px-3 py-1.5 rounded-md cursor-pointer text-xs font-semibold font-quicksand duration-150 ${
                    chartType === "ganancias"
  ...
  return (
    <section className="w-full p-5 h-full flex justify-between items-center">
      <section className="w-1/4 h-full shadow-md border border-gray-200 flex rounded-xl items-center flex-col p-4">
        {logo ? (
          <img
            src={logo}
            alt="Logo Comercio"
        ...
        <section className="w-full flex flex-col mt-auto">
          <button
            ...
            className="w-full bg-gradient-to-r from-sky-800 to-sky-700 cursor-pointer hover:from-sky-700 hover:to-sky-800 text-white font-semibold py-3 px-4 rounded-xl duration-200 shadow-md hover:shadow-lg font-quicksand flex items-center justify-center"
          >
            Añadir Producto
          </button>
          <button
            ...
            className="w-full bg-gradient-to-r from-sky-800 to-sky-700 cursor-pointer hover:from-sky-700 hover:to-sky-800 text-white font-semibold py-3 px-4 rounded-xl duration-200 shadow-md hover:shadow-lg font-quicksand flex items-center justify-center translate-y-1.5"
          >
            Ver Mis Productos
          </button>
        </section>
      ...
      <section className="w-2/5 mr-2 bg-white shadow-md flex flex-col border p-3 rounded-xl border-gray-200 h-full">
        <section className="flex items-center justify-between mb-6 pb-4 border-b border-gray-100">
          ...
          <section className="flex gap-2 bg-gray-50 p-2 rounded-4xl">
            <button
              onClick={() => setChartType("ventas")}
              className={`px-4 py-2 rounded-md text-xs font-semibold cursor-pointer font-quicksand duration-150 ${
                chartType === "ventas"
            ...
            <button
              onClick={() => setChartType("ganancias")}
              className={`px-4 py-2 rounded-md text-xs cursor-pointer font-semibold font-quicksand duration-150 ${
                chartType === "ganancias"
        ...
        <section className="flex gap-2 mb-4">
          {[
            ...
            <button
              key={key}
              onClick={() => setTimeRange(key)}
              className={`px-4 py-1.5 rounded-md text-xs cursor-pointer font-semibold font-quicksand duration-150 ${
                timeRange === key
                  ? "bg-gray-800 text-white"
