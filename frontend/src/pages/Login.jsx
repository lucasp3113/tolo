  ...
  function loginRequest(data) {
    axios
      ...
      .then((res) => {
        ...
        const urls = {
          ecommerce: ecommerce
            ...
            : "/ecommerce_dashboard",
          vendedor_particular: ecommerce
            ? `/${ecommerce}/seller_dashboard`
            : "/seller_dashboard",
      ...
      .catch((err) => {
        ...
        message && message[1]
          ? undefined
          : setError(err.response.data.input, {
              type: "manual",
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col mt-3 ml-3 items-start ">
        <h2 className="font-[Montserrat,sans-serif] text-2xl font-semibold">
          Login
        </h2>
        <p className="text-sm whitespace-nowrap text-gray-600">
          Completá el formulario para iniciar sesión.
        </p>
      </div>
      <Input
        icon={<FaUserCircle />}
