        ...
        >
          ...
          <div className="flex flex-col mr-7 w-full md:w-[60%] lg:w-[65%]">
            ...
            <section className="text-gray-700 p-3">
              ...
              <div className="p-3 rounded-md">
                <Form
                  className="w-160! shadow-none! -translate-x-8"
                  fields={[
                    <Rating
                      key="rating"
                      id="user-rating"
          ...
          <div className="flex flex-col items-start w-full md:w-[400px] lg:w-[30%] ml-auto border border-gray-200 rounded-md p-3">
            ...
            <div className="flex justify-between items-center w-full my-2">
              ...
              <div className="h-9 w-px bg-gray-300 mx-10"></div>
              <div>
            ...
            <section className="flex justify-center mt-5">
              <div className="flex cursor-pointer p-2 h-14 w-88 transition-colors duration-200 hover:bg-[#f0ecec]">
                <div>
                ...
                >
                  <span>
                    Vendido por: <button>El Letra</button>{" "}
                  </span>
                </div>
              </div>
            </section>
