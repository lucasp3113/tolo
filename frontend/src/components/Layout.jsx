...
export default function Layout({ children, search = false, coin = false, setSearchData, logo = true, logoEcommerce, setUserType, preview = false, colors = null, goodContrast = null, change = null }) {
  ...
  return (
    <div className="grid min-h-dvh grid-rows-[auto_1fr_auto]">
      <HeaderNav preview={preview} coin={coin} color={headerColor} setUserTypeForAdmin={setUserType} setPanelFilter={setPanelFilter} logoEcommerce={logoEcommerce} logo={logo} search={search} setSearchData={setSearchData} setDataCategories={setDataCategories} setWord={setWord} />
