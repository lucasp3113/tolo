...
const Dropdown = ({
  ...
  return (
    ...
    >
      ...
      <ul
        className={`absolute ${getDirectionStyles()} z-50 w-auto min-w-max bg-white text-gray-800 shadow-lg rounded-md overflow-visible transition-all duration-300 ease-in-out whitespace-nowrap ${
