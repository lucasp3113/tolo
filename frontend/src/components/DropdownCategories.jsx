...
export default function DropdownCategories({
    ...
    const isSelected = (name) =>
        ...
        selected.some((item) => item.nombre_categoria === name);
                    ...
                    content: (
                        <fieldset className="flex flex-col items-start justify-center">
                            <Input
                                ...
                                errors={errors}
                                className="!flex-row"
                                defaultChecked={isSelected("Calzado")}
                            />
                            <Input
                                type="checkbox"
                                name="Ropa hombre"
                                ...
                                errors={errors}
                                className="!flex-row"
                                defaultChecked={isSelected("Ropa hombre")}
                            />
                            <Input
                                type="checkbox"
                                name="Ropa mujer"
                                ...
                                errors={errors}
                                className="!flex-row"
                                defaultChecked={isSelected("Ropa mujer")}
                            />
                            <Input
                                type="checkbox"
                                name="Ropa unisex"
                                ...
                                errors={errors}
                                className="!flex-row"
                                defaultChecked={isSelected("Ropa unisex")}
                            />
                            <Input
                                type="checkbox"
                                name="Ropa niño"
                                ...
                                errors={errors}
                                className="!flex-row"
                                defaultChecked={isSelected("Ropa niño")}
                            />
                            <Input
                                type="checkbox"
                                name="Ropa niña"
                                ...
                                errors={errors}
                                className="!flex-row"
                                defaultChecked={isSelected("Ropa niña")}
                            />
                        </fieldset>
                    ),
                },
                    ...
                    content: (
                        <fieldset className="flex flex-col items-start justify-center">
                            <Input
                                ...
                                errors={errors}
                                className="!flex-row"
                                defaultChecked={isSelected("Electrónica")}
                            />
                            <Input
                                type="checkbox"
                                name="Computación"
                                ...
                                errors={errors}
                                className="!flex-row"
                                defaultChecked={isSelected("Computación")}
                            />
                            <Input
                                type="checkbox"
                                ...
                                errors={errors}
                                className="!flex-row"
                                defaultChecked={isSelected("Celulares y accesorios")}
                            />
                            <Input
                                type="checkbox"
                                name="Videojuegos"
                                ...
                                errors={errors}
                                className="!flex-row"
                                defaultChecked={isSelected("Videojuegos")}
                            />
                        </fieldset>
                    ),
                },
                    ...
                    content: (
                        <fieldset className="flex flex-col items-start justify-center">
                            <Input
                                ...
                                errors={errors}
                                className="!flex-row"
                                defaultChecked={isSelected("Vehículos")}
                            />
                            <Input
                                type="checkbox"
                                ...
                                errors={errors}
                                className="!flex-row"
                                defaultChecked={isSelected("Repuestos y autopartes")}
                            />
                            <Input
                                type="checkbox"
                                name="Motocicletas"
                                ...
                                errors={errors}
                                className="!flex-row"
                                defaultChecked={isSelected("Motocicletas")}
                            />
                            <Input
                                type="checkbox"
                                name="Náutica"
                                ...
                                errors={errors}
                                className="!flex-row"
                                defaultChecked={isSelected("Náutica")}
                            />
                        </fieldset>
                    ),
                },
                    ...
                    content: (
                        <fieldset className="flex flex-col items-start justify-center">
                            <Input
                                ...
                                errors={errors}
                                className="!flex-row"
                                defaultChecked={isSelected("Electrodomésticos")}
                            />
                            <Input
                                type="checkbox"
                                name="Hogar y Cocina"
                                ...
                                errors={errors}
                                className="!flex-row"
                                defaultChecked={isSelected("Hogar y Cocina")}
                            />
                            <Input
                                type="checkbox"
                                ...
                                errors={errors}
                                className="!flex-row"
                                defaultChecked={isSelected("Herramientas y Ferretería")}
                            />
                            <Input
                                type="checkbox"
                                ...
                                errors={errors}
                                className="!flex-row"
                                defaultChecked={isSelected("Jardín y exteriores")}
                            />
                        </fieldset>
                    ),
                },
                    ...
                    content: (
                        <fieldset className="flex flex-col items-start justify-center">
                            <Input
                                ...
                                errors={errors}
                                className="!flex-row"
                                defaultChecked={isSelected("Alquiler de campos")}
                            />
                            <Input
                                type="checkbox"
                                ...
                                errors={errors}
                                className="!flex-row"
                                defaultChecked={isSelected("Alquiler de casas")}
                            />
                            <Input
                                type="checkbox"
                                ...
                                errors={errors}
                                className="!flex-row"
                                defaultChecked={isSelected("Alquiler de herramientas")}
                            />
                        </fieldset>
                    ),
                },
                    ...
                    content: (
                        <fieldset className="flex flex-col items-start justify-center">
                            <Input
                                ...
                                errors={errors}
                                className="!flex-row"
                                defaultChecked={isSelected("Bebés y niños")}
                            />
                            <Input
                                type="checkbox"
                                name="Juguetes"
                                ...
                                errors={errors}
                                className="!flex-row"
                                defaultChecked={isSelected("Juguetes")}
                            />
                        </fieldset>
                    ),
                },
                    ...
                    content: (
                        <fieldset className="flex flex-col items-start justify-center">
                            <Input
                                ...
                                errors={errors}
                                className="!flex-row"
                                defaultChecked={isSelected("Oficina y papelería")}
                            />
                            <Input
                                type="checkbox"
                                name="Libros"
                                ...
                                errors={errors}
                                className="!flex-row"
                                defaultChecked={isSelected("Libros")}
                            />
                        </fieldset>
                    ),
                },
                    ...
                    content: (
                        <fieldset className="flex flex-col items-start justify-center">
                            <Input
                                ...
                                errors={errors}
                                className="!flex-row"
                                defaultChecked={isSelected("Ganado bovino")}
                            />
                            <Input
                                type="checkbox"
                                name="Ganado ovino"
                                ...
                                errors={errors}
                                className="!flex-row"
                                defaultChecked={isSelected("Ganado ovino")}
                            />
                            <Input
                                type="checkbox"
                                name="Ganado equino"
                                ...
                                errors={errors}
                                className="!flex-row"
                                defaultChecked={isSelected("Ganado equino")}
                            />
                            <Input
                                type="checkbox"
                                name="Ganado caprino"
                                ...
                                errors={errors}
                                className="!flex-row"
                                defaultChecked={isSelected("Ganado caprino")}
                            />
                        </fieldset>
                    ),
                },
                    ...
                    content: (
                        <fieldset className="flex flex-col items-start justify-center">
                            <Input
                                ...
                                errors={errors}
                                className="!flex-row"
                                defaultChecked={isSelected("Perros")}
                            />
                            <Input
                                type="checkbox"
                                name="Gatos"
                                ...
                                errors={errors}
                                className="!flex-row"
                                defaultChecked={isSelected("Gatos")}
                            />
                            <Input
                                type="checkbox"
                                name="Mascotas"
                                ...
                                errors={errors}
                                className="!flex-row"
                                defaultChecked={isSelected("Mascotas")}
                            />
                        </fieldset>
                    ),
                },
                    ...
                    content: (
                        <fieldset className="flex flex-col items-start justify-center">
                            <Input
                                ...
                                errors={errors}
                                className="!flex-row"
                                defaultChecked={isSelected("Agro e insumos rurales")}
                            />
                            <Input
                                type="checkbox"
                                ...
                                errors={errors}
                                className="!flex-row"
                                defaultChecked={isSelected("Herramientas de campo")}
                            />
                            <Input
                                type="checkbox"
                                ...
                                errors={errors}
                                className="!flex-row"
                                defaultChecked={isSelected("Maquinaria agrícola")}
                            />
                            <Input
                                type="checkbox"
                                ...
                                errors={errors}
                                className="!flex-row"
                                defaultChecked={isSelected("Alimentos agroindustriales")}
                            />
                            <Input
                                type="checkbox"
                                ...
                                errors={errors}
                                className="!flex-row"
                                defaultChecked={isSelected("Productos orgánicos")}
                            />
                        </fieldset>
                    ),
                },
